...
use base64::Engine;
use anchor_lang::{event, prelude::Pubkey, prelude::borsh, AnchorDeserialize};
use anyhow::{anyhow, Result};

use crate::{transaction::wrapper::TransactionWrapper, utils::{format_with_decimals, WSOL}};
...
pub fn pumpfun_event_to_swap(trade_event: &TradeEvent, tx: &TransactionWrapper, slot: u64, block_time: i64) -> Result<Option<SwapInfo>> {
